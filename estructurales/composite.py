...
class Component(ABC):
    ...
    object tree assembly. The downside is that these methods will be empty for the
    ...
    def is_composite(self) -> bool:
        """
        You can provide a method that lets the client code figure out wheter a
...
class Leaf(Component):
    ...
    objects only delegate to ther sub-components.
    """
    def operation(self) -> str:
        return "Leaf"
